...
export default function KpiRow({
  ...
  if (!d && pairList) {
    ...
    d = {
      ...
      pnlRealise: sPnlR, pnlRealisePct: sDepose > 0 ? (sPnlR / sDepose) * 100 : 0,
      pnlLatent:  sPnlL, pnlLatentPct:  sDepose > 0 ? (sPnlL / sDepose) * 100 : 0,
      pnlTotal: sPnlR + sPnlL, pnlTotalPct:   sDepose > 0 ? ((sPnlR + sPnlL) / sDepose) * 100 : 0,
