...
function buildKpis(rows, capitalDepose, capitalDispo) {
  ...
  return {
    ...
    pnlRealise,  pnlRealisePct: pctOf(pnlRealise, capitalDepose),
    pnlLatent,   pnlLatentPct:  pctOf(pnlLatent,  capitalDepose),
    pnlTotal,    pnlTotalPct:   pctOf(pnlTotal,   capitalDepose),    
